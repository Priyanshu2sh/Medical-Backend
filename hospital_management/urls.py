...
# Lab reports
    ...
    path('lab-reports/by-patient-id/<int:patient_id>', LabReportsByPatientIdView.as_view(), name='lab-reports-by-patient-id'),
    ...
    path('hero-data/<str:hospital_id>', HospitalDynamicContentAPI.as_view(), name="hospital-hero-data"),
    path('opd-data/', OPDServiceDataContentAPI.as_view(), name="hospital-opd-data"),
    path('opd-data/<str:hospital_id>', OPDServiceDataContentAPI.as_view(), name="hospital-opd-data"),
    path('why-choose-us/', HospitalWhyChooseSectionAPI.as_view(), name="why-choose-us"),
    path('why-choose-us/<str:hospital_id>', HospitalWhyChooseSectionAPI.as_view(), name="why-choose-us"),
    path('doctors/', DoctorsListAPI.as_view(), name="doctors"),
    path('doctors/<str:hospital_id>', DoctorsListAPI.as_view(), name="doctors"),
    path('our-specialities/', OurSpecialitiesAPI.as_view(), name="our-specialities"),
    path('our-specialities/<str:hospital_id>', OurSpecialitiesAPI.as_view(), name="our-specialities"),
    path('hospital-contact/', HospitalContactUsAPI.as_view(), name="hospital-contact"),
    path('hospital-contact/<str:hospital_id>', HospitalContactUsAPI.as_view(), name="hospital-contact"),
    path('hospital-job-openings/', HospitalJobOpeningsAPI.as_view(), name="hospital-job-openings"),
    path('hospital-job-openings/<str:hospital_id>', HospitalJobOpeningsAPI.as_view(), name="hospital-job-openings"),
    path('get-hospital-id', GetHospitalIdAPI.as_view(), name="get-hospital-id"),
