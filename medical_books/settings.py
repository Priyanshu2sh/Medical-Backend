"""
Django settings for medical_books project.
...
SECRET_KEY = 'django-insecure-oow7atl$%ct45x5z$*5crtsl9-@m6h*-#we@@=l(wk8ilf9b=#'
...
MIDDLEWARE = [
    'medical_book.SanitizeHostMiddleware'
...
ROOT_URLCONF = 'medical_books.urls'
